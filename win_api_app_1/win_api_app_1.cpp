...
HWND one, two, three, four, five, six, seven, eight, nine, zero, add, delenie, sub, mul, scr, clear, eq;
...
float firstSet = 0, Secondset = 0, Result = 0;
...
void buttons(HWND btn_handler)
{
	...
	add = CreateWindowEx(0, L"BUTTON", L"+", WS_CHILD | WS_VISIBLE | WS_BORDER, 210, 42, 70, 80, btn_handler, (HMENU)btn_plus, NULL, NULL);
	//Buttons for 4, 5, 6, -
	...
	sub = CreateWindowEx(0, L"BUTTON", L"-", WS_CHILD | WS_VISIBLE | WS_BORDER, 210, 122, 70, 80, btn_handler, (HMENU)btn_minus, NULL, NULL);
	//Buttons for 7, 8, 9, X
	...
	mul = CreateWindowEx(0, L"BUTTON", L"X", WS_CHILD | WS_VISIBLE | WS_BORDER, 210, 202, 70, 80, btn_handler, (HMENU)btn_times, NULL, NULL);
	//Buttons for C, 0, =, /.
	...
	eq = CreateWindowEx(0, L"BUTTON", L"=", WS_CHILD | WS_VISIBLE | WS_BORDER, 140, 282, 70, 80, btn_handler, (HMENU)btn_equal, NULL, NULL);
	delenie = CreateWindowEx(0, L"BUTTON", L"/", WS_CHILD | WS_VISIBLE | WS_BORDER, 210, 282, 70, 80, btn_handler, (HMENU)btn_divide, NULL, NULL);
}